...
if __name__ == "__main__":
    ...
    label_folder_path = "./test/origin/"
    prediction_folder_path = "./test/predict/"
        ...
        if len(json_files) > 0:
            ...
            for prediction_filename in tqdm(json_files):
                ...
                try:
                    ...
                    label_file_path = "./test/origin/sim_000000.json"
    ...
    print(true_positive_all_files,false_positive_all_files)
